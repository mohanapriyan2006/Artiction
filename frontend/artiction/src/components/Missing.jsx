...
const Missing = () => {
  ...
  return (
    <div className="missing place-content-center place-items-center mt-10">
      ...
      <h5 className='md:text-4xl sm:text-3xl text-2xl font-semibold mt-8'> Go to <button onClick={() => { navigate('/'); setActive('home') }} className="btn-2 cursor-pointer">Home</button> </h5>
