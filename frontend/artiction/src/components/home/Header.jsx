...
const Header = () => {
  return (
    <div className='home-header mt-5 m-auto flex sm:flex-row flex-col items-center justify-around'>
      <div className="header_img">
        <img src={home_img} alt="Home image preview" className="w-110 " />
      </div>
      <div className="header_content w-150 mt-10 text-center sm:text-start">
