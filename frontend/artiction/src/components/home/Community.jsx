  ...
  return (
    <div className='home-community mb-10'>
      <div className="divider">
        <span>-</span>
        <b className='font2 font-bold text-[32px] -mt-5'> Join the Community </b>
        <span>-</span>
      </div>

      {/* Be Part of the Art Revolution! */}
      <div className="title flex flex-col items-center mt-5">
        <b className='font2 font-bold text-[30px]'>Be Part of the Art Revolution!</b>
      ...
      <div className="title flex flex-col items-center mt-10">
        <b className='font2 font-bold text-[30px]'>Stay Connected with the World of Art</b>
        <span className='title-line'>-</span>
      </div>

      <div className="subscribe-div flex md:flex-row flex-col-reverse  justify-around px-10 py-5 mx-15">

        <div className='text-center flex flex-col justify-center px-20'>
          <h2 className='text-[22px] font-semibold mb-2'>Newsletter Subscription</h2>
          <p className='text-[18px] text-gray-600 mx-5 mb-5'>Subscribe to receive the latest updates on exclusive auctions, featured artists, and upcoming exhibitions.</p>
        ...
        <div>
          <img className='h-auto md:w-150 w-100 m-auto' src={subImg} alt="img"  />
        </div>
